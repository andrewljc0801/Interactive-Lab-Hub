...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            # get offset of the mouse position
            offsetX = mouseX % 40
            offsetY = mouseY % 40
            # Fix the piece location
            if offsetX != 0:
            ...
            mouse_X = mouse_X - mouse_X % 20
            mouse_Y = mouse_Y - mouse_Y % 20
            # get offset of the mouse position
            offset_X = mouse_X % 40
            offset_Y = mouse_Y % 40
            # Fix the piece location
            ...
            if current_position[0] in range(120, 681) and current_position[1] in range(120, 681) and last_mouse_position != current_position:
                draw_board()
